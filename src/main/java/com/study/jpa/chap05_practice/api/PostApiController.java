...
import com.study.jpa.chap05_practice.dto.PostRequestDTO;
...
public class PostApiController {
    ...
    /*
        ...
        게시물 등록:     /posts            - POST, payload : (writer, title, content, hasTags)
    ...
    */
    ...
    // 게시물 등록
    @PostMapping
    public ResponseEntity<?> create(@Validated @RequestBody PostRequestDTO dto,
        ...
        // dto가 null이 아니고 입력값 검증도 모두 통과 -> service에게 insert 명령
        try {
